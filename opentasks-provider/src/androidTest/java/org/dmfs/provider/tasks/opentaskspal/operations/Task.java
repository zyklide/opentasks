...
package org.dmfs.provider.tasks.opentaskspal.operations;
...
public final class Task implements InsertOperation<TaskContract.Tasks>
{
    private final InsertOperation<TaskContract.Tasks> mDelegate;


    public Task(@NonNull RowSnapshot<TaskContract.TaskLists> taskList, @NonNull InsertOperation<TaskContract.Tasks> original)
    {
